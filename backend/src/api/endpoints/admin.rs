...
pub async fn activate_subscription(
    ...
    let plan = body.plan.parse::<SubscriptionPlan>()
        .map_err(|_| (StatusCode::BAD_REQUEST, format!("Plan inválido: '{}'. Use 'monthly' o 'annual'", body.plan)))?;

    let sub = state.subscription_use_cases
...
pub async fn list_subscriptions(
    ...
    let subs = state.subscription_use_cases
