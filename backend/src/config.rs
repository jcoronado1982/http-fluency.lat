...
impl Settings {
    pub fn from_env() -> anyhow::Result<Self> {
        ...
        let settings = Settings {
            ...
            gcs_images_prefix: env::var("GCS_IMAGES_PREFIX").unwrap_or_else(|_| "card_images".to_string()),
            ...
            sync_to_oracle: env::var("SYNC_TO_ORACLE").unwrap_or_else(|_| "false".to_string()).parse::<bool>().unwrap_or(false),
