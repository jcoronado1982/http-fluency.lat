export const landingTranslations = {
    es: {
        ...
        heroTitle: 'Aprende inglés desde el primer día.',
        heroMission:
        ...
        highlightsTitle: 'Por qué Fluency',
        highlightWords: 'Más de 5,000 palabras',
        highlightWordsDesc: 'Vocabulario esencial A1 → B2 organizado por categorías y niveles CEFR.',
        highlightStreak: 'Racha y XP diarios',
        highlightStreakDesc: 'Mantén tu motivación con racha, puntos de experiencia y metas claras.',
        highlightCefr: 'Niveles CEFR',
        highlightCefrDesc: 'Sigue tu avance de A1 a B2 con un panel visual y metas precisas.',
        highlightAi: 'Imágenes con IA',
        highlightAiDesc: 'Cada palabra tiene una imagen generada con IA para fijarla en tu memoria.',
        highlightAudio: 'Audio nativo',
        highlightAudioDesc: 'Escucha la pronunciación correcta en cada tarjeta con acento nativo.',
    ...
    en: {
        ...
        heroTitle: 'Learn English from day one.',
        heroMission:
            'Designed for you to learn from day one. We cut the noise to focus exclusively on high-impact vocabulary that moves the real world.',
        heroSubtitle:
            'Interactive flashcards, native audio, AI images, and CEFR progress tracking.',
        ...
        highlightsTitle: 'Why Fluency',
        highlightWords: 'More than 5,000 words',
        highlightWordsDesc: 'Essential A1 → B2 vocabulary organized by category and CEFR level.',
        highlightStreak: 'Daily streak and XP',
        highlightStreakDesc: 'Stay motivated with a streak, experience points, and clear goals.',
        highlightCefr: 'CEFR levels',
        highlightCefrDesc: 'Track your progress from A1 to B2 with a visual dashboard and precise goals.',
        highlightAi: 'AI images',
        highlightAiDesc: 'Every word has an AI-generated image to lock it into memory.',
        highlightAudio: 'Native audio',
        highlightAudioDesc: 'Hear correct pronunciation on every card with a native accent.',
